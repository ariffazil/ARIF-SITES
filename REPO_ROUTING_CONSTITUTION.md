...
| **GEOX** | Earth domain, geo/terrain/maps, well logs | `/root/GEOX/` | `github.com/ariffazil/geox` |
...
1. Finance → WEALTH. MCP/floors → arifOS. Earth/subsurface → GEOX. Agent governance → AAA. Design → A-FORGE. Web → arif-sites.
