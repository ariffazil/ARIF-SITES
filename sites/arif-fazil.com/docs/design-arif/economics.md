# Economics — `/economics` — "The Price of a Risk"

**Register**: Ledger green `#1E6F50` + brass `#B08D3E` on cream `#F7F3E8`. A working ledger — ruled columns, debit/credit energy. Contrast: orderly and analog after Earth's dark pressure.
...
**Animation**: headline words rise staggered 0.09s; ledger tally starts counting on enter; ledger rules draw horizontally left→right.

---

## Section 2 — THREE LENSES (accordion)
...
## Section 3 — ENERGY, IN PLAIN NUMBERS (fact table)

**Layout**: A ruled ledger table (hairlines, mono figures right-aligned, brass totals row). Rows are short, honest, tagged:

| Claim | Figure | Tag |
|---|---|---|
| Approx. share of PETRONAS revenue flowing to government (dividends, tax, royalty) | ~70.5% of extraction economics, arithmetic | `[OBS]` |
...
## Section 4 — ESSAYS (index)

**Layout**: Numbered essay list (mono index, Fraunces 28px titles, one-line summaries), 4–6 essays on energy economics, subsidy design, and risk. Each links to `/writing`.

**Animation**: rows fade up staggered; hover indents the row 12px with a green left border drawing in.

---

## Section 5 — BRIDGE

**Layout**: Brass-ruled strip: *"Incentives explain nations. They also explain machines."* → link to `/doctrine` in cold blue.

**Animation**: simple fade; link underline draws on hover.

**Assets**: `ledger-texture.png`.
