...
# ── EUREKA Signal: Term Structure (backwardation/contango) ──────
# Oil physics: the futures curve IS the supply/demand signal.
# Backwardation = physical tightness = bullish.
# Contango = oversupply = bearish.
# This uses a roll-yield proxy: (spot / SMA200) — when spot is above
# its long-term average, the curve tends toward backwardation.
